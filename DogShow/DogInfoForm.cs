...
namespace DogShow
{
    ...
    public partial class DogInfoForm : Form
    {
       ...
       public int breedID;
        private Image outline = DogShow.Properties.Resources.pawOutlineNew;
        private Image filledIn = DogShow.Properties.Resources.bluePaw;
        ...
        private void ViewBtn_Click(object sender, EventArgs e)
        {
            ...
            var breeds = Pull.BreedNames((Classes)breedIndex);
        ...
        private void ChooseBreedBtn_Click(object sender, EventArgs e)
        {
            ...
            breedID = Pull.BreedNum(BreedBox.SelectedItem.ToString());
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
           ...
           if (femRad.Checked)
            ...
            Pull.InsertDoggo(breedID, firstName, gender);
